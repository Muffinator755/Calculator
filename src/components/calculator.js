      ...
      <div className="calculator">
        ...
        <div className="calculator__keypad">
          <div className="calculator__keys">
            <div classname="caculator_function-keys">
            ...
            <div className="calculator__digit-keys">
              ...
              <button className="calculator__button__key-." label="." value=".">.</button>
            </div>
            <div className="operator-keys">
              <button className="calculator__button__division_key" label="÷" value="divide">÷</button>
